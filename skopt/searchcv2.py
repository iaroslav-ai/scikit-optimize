...
from . import Optimizer, gp_minimize
from .utils import point_asdict, dimensions_aslist, point_aslist
from .space import check_dimension

class BayesSearchCV2(sk_model_sel.BaseSearchCV):
    ...
    def __init__(self, estimator, search_spaces=None, optimizer_kwargs=None,
        ...
        super(BayesSearchCV2, self).__init__(
    ...
    def process_point(self, params, search_space, X, y, groups):
    ...
    def fit(self, X, y=None, groups=None):
        ...
        for space_id in sorted(self.search_spaces_.keys()):
            ...
            gp_minimize(obj, dimensions_aslist(elem), n_calls=n_iter)
